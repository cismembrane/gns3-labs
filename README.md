...
Each lab directory contains a `README.md` with the full topology, IP addressing, configuration walkthrough, and verification steps. Router configs are in the `configs/` directory. GNS3 project files are included where applicable, built against Cisco c7200 `adventerprisek9` images running on Dynamips.
